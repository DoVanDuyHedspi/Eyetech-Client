                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media justify-content-between">
                                    <div>
                                        <p class="">Total Customer</p>
                                        <h2 class="font-size-28 font-weight-light">321</h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media justify-content-between">
                                    <div>
                                        <p class="">Today</p>
                                        <h2 class="font-size-28 font-weight-light">0</h2>
                            ...
                            <div class="card-body">
                                <div class="media justify-content-between">
                                    <div>
                                        ...
                                        <h2 class="font-size-28 font-weight-light">58%</h2>
                            ...
                            <div class="card-body">
                                <div class="media justify-content-between">
                                    <div>
                                        ...
                                        <h2 class="font-size-28 font-weight-light">43</h2>
                                        <span class="text-semibold text-success font-size-15">
                                                    <i class="ti-arrow-up font-size-11"></i>
                                                    <span>18%</span>
                                                </span>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center m-t-20">
                                    <h2 class="font-weight-light font-size-30 m-b-0">321</h2>
                                    <p class="opacity-07">Total Customers</p>
                                </div>
                                <div class="m-t-60">
